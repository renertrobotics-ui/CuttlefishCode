...
public class blueteleop extends NextFTCOpMode {
    ...
    public blueteleop() {
        addComponents(
                ...
                new SubsystemComponent(DriveSubsystem.INSTANCE, TurretSubsystem.INSTANCE/*, Intake.INSTANCE, Spindexer.INSTANCE*/),
...
//        limelight.start();
    ...
    public void onUpdate() {
        turret_on_via_encoder_and_crservos(Math.PI/2);
        //float newtps=1000;
        //shooter(newtps);
