...
@Autonomous(name = "red push autonomous", group = "Examples")
public class RED_PUSH_AUTO extends OpMode {
    ...
    private final Pose humanclosePose = new Pose (50, 6, Math.toRadians(-90));
    private final Pose humanPose = new Pose (50, 0, Math.toRadians(-90));
    ...
    private void pinpointautoaim() {
        ...
        if (pathState  == -2) {
            counterturret.setPosition(0.52 + turnneed/665);
